...
rel_members = Table("members", relational_meta,
    ...
    Column("registerdate_date",                 Date),
    Column("registerdate_time",                 Time),
    Column("updatedate_date",                   Date),
    Column("updatedate_time",                   Time),
    Column("lastaccessdate_date",               Date),
    Column("lastaccessdate_time",               Time),
    Column("conversiondate_date",               Date),
    Column("conversiondate_time",               Time),
)
...
rel_dim_partnerships = Table("dim_partnerships", relational_meta,
    Column("idmember",   Integer,    ForeignKey("data_warehouse.members.idmember"), primary_key=True),
    Column("plataforma", String(50), primary_key=True),
...
rel_sales = Table("sales", relational_meta,
    ...
    Column("valuenextmonth",                Numeric(12, 2)),
    Column("saledate_date",                 Date),
    Column("saledate_time",                 Time),
    Column("updatedate_date",               Date),
    Column("updatedate_time",               Time),
)
